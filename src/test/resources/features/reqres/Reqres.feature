Feature: Serenity Rest QE 13
  ...
  Scenario: Post create user with valid json
    ...
    And Response body name was "Neni Nurhaeni" and job was "QA Engineer"
  ...
  Scenario Outline: Update user with valid id and json
    ...
    Examples:
      | id | json             | name                 | job                |
      | 1  | UpdateUser.json  | Neni Nurhaeni Edit   | QA Engineer Edit   |
      | 2  | UpdateUser2.json | Neni Nurhaeni Edit 2 | QA Engineer Edit 2 |
  @Latihan
